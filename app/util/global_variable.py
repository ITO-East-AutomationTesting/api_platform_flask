...
REPORT_ADDRESS = os.path.join(base_dir, 'reports')
LOG_ADDRESS = os.path.join(base_dir, 'logs')
TEMP_REPORT = os.path.join(base_dir, 'app/util/report')
FUNC_ADDRESS = os.path.join(base_dir, 'func_list')
FILE_ADDRESS = os.path.join(base_dir, 'files')
...
if __name__ == '__main__':
     print(os.path.join(REPORT_ADDRESS, '{}.txt'.format(1)))